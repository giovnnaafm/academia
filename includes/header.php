...
<header>
    <div class="w-full bg-slate-800 p-6 shadow-lg">
        ...
        <nav class="pt-6 flex space-x-4 justify-center">
            ...
            <a href="index.php?logout=true" class="text-white text-lg font-medium border border-red-400 rounded-lg px-4 py-2 transition duration-300 hover:bg-red-400 hover:text-slate-800">Sair</a>
        </nav>
    </div>
</header>
</body>
